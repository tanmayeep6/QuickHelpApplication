...
<div class="bgimgs">
	...
	<div  style="width: 100% ; height:88%;  display: flex; justify-content: center; " >
		<form action="regis" method="post" style="background-color:white; border-radius: 15px; height: 70vh; width: 300px; padding : 30px 20px 0px; margin-top: 50px; overflow-y:scroll;" class="display-flex align-content-center align-items-center example">
