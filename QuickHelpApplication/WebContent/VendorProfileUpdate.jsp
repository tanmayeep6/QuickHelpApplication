...
<div class="bgimgs b">
	<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: black; opacity: 100%">
		<div class="container">
		<a href="UserHome.jsp" class="navbar-brand title ">QuickHelp &trade;</a>
		...
		<div class="collapse navbar-collapse text-center" id="a" >
			<ul class="navbar-nav ml-auto">
				...
				<li>   
					<div >
							 <a href="VendorDetails.jsp" class="nav-link text-white bg-success" style="border-radius: 7px ; height: 7vh; width: 15vh;">Back</a>
	...
	<div  style="width: 100% ; height:80%;  display: flex; justify-content: center;overflow: hidden " >
		<form action="login" method="post" style=" height: 92vh; width: 600px; padding : 30px 20px 0px; margin-top: 50px; overflow-y:scroll;" class="b display-flex align-content-center align-items-center example ">
			...
			<div class="row">
			<label class="font-weight-bold col-6 d-flex justify-content-end a mr-3">Service :</label>
			<div class="form-group d-flex justify-content-start"><input class="form-control" type="text" id="occupation" name="occupation" placeholder="Service"><div></div>  </div>
			</div>
